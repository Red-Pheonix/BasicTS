...
from ..base_tsf_runner import BaseTimeSeriesForecastingRunner, TimeSeriesForecastingInferenceRunner
...
class InferenceTimeSeriesForecastingRunner(TimeSeriesForecastingInferenceRunner):
    """
    A Simple Runner for Time Series Forecasting: 
    Selects forward and target features. This runner is designed to handle most cases.
